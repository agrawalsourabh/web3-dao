    ...
    render(){
        return(
            <footer className="pv4 ph3 ph5-m ph6-l white bg-mid-gray">
                ...
                <a class="link hover-silver near-black dib h2 w2 mr3 center" href={urls.link.twitter} title="Twitter" target="_blank">
                    <img src={twitter_img} alt="twitter"/>
                </a>
                <a class="link hover-silver near-black dib h2 w2 mr3 center" href={urls.link.discord} title="Discord" target="_blank">
